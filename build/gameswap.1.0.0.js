...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	    var gameswapApp = new _view2.default();
	    ...
	    $(".nav #searchMenu").click(function (e) {
	        $(".nav").show();
	        $("#profile").hide();
	        $("#search").show();
	        $("#create-profile").hide();
	        $("#loginform").hide();
	        $("#home").hide();
	        var showMatches = function showMatches() {
	            $("#game-search").submit(function (event) {
	                event.preventDefault();
	                console.log("The data was submitted");
	                gameswapApp.showSearchResults(".games-owned", ".games-wanted", ".city");
	    ...
	    $(".nav #profileMenu").click(function (e) {
	        $(".nav").show();
	        $("#profile").show();
	        $("#create-profile").hide();
	        $("#loginform").hide();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameswapView = function () {
	  function GameswapView() {
	    _classCallCheck(this, GameswapView);
	  ...
	  _createClass(GameswapView, [{
	    key: "showForm",
	    value: function showForm() {
	      var cities = this.services.cities();
	    ...
	    value: function showSearchResults(owned, wanted, city) {
	      var ownedval = $(owned).val();
	      var wantedval = $(wanted).val();
	      var cityval = $(city).val();
	      var data = this.services.profile(); //in the future, will make the API call here
	      var myClass = this;
...
/***/ function(module, exports) {
	...
	var GameswapServices = function () {
	    function GameswapServices() {
	        _classCallCheck(this, GameswapServices);
	    }
	
	    _createClass(GameswapServices, [{
	        key: "cities",
	        ...
	        key: "signin",
	        value: function signin(first_name, last_name, email, password, city, state, callback) {
	            var data = {
	        ...
	        key: "getgames",
	        value: function getgames(username, password, callback) {
	        ...
	        key: "mygames",
	        value: function mygames(usernameVal, passwordVal, callback) {
	            $.ajax({
	                type: "GET",
	                url: "/mygames",
	                dataType: 'json',
	        ...
	        key: "addgame",
	        value: function addgame(username, password) {
	            var usernameVal = $(username).val();
	            var passwordVal = $(password).val();
	        ...
	        key: "deletegame",
	        value: function deletegame(username, password, callback) {
	            var usernameVal = $(username).val();
	            var passwordVal = $(password).val();
	    ...
	    return GameswapServices;
	}();
	
	exports.default = GameswapServices;
...
/***/ }
/******/ ]);
//# sourceMappingURL=gameswap.1.0.0.js.map